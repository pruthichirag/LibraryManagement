...
<table width="100%" height="369" border="0">
  <tr>
    <td width="24%" height="365" align="center" valign="top"><p align="left" class="style2">NAME : <?php 
...
$row = mysql_fetch_array($result);
 ...
 echo $name2; ?>
      ...
      <tr>
        <td bgcolor="#00FF00" height="157"><img src="<?php 
    ...
    </form>    <p><a href="bookdet.php">BOOK DETAILS</a></p></td>
    <td width="30%" align="center" valign="top" class="style2"><p>BOOK RETURN DETAILS </p>
      <table width="100%" height="212" border="0">
        <tr>
          <td width="39%" valign="top"><p align="right"></p>
            <p align="right">&nbsp;</p>
          <p align="right"></p></td>
          <td width="61%" valign="top" class="style2"><p>
		   <?php
$k=0;
...
?>
      ...
      <table width="100%" height="52" border="0">
        <tr>
          <td width="52%" height="48" valign="top"><div align="right">FINE AMOUNT= Rs.</div></td>
          <td width="48%" valign="top"><div align="left"><P><?php
		   $fine1=0;
